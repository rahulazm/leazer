    ...
    var clndrTemplate =
        ...
        "<div class='clndr-controls'>" +
            "<div class='clndr-control-button'>" +
                "<span class='clndr-previous-button'><a id='priviousmonth' href='javascript:void(0)' data-year='<%= year %>' data-month='<%= month %>'><i class='fa fa-angle-left' aria-hidden='true'></i></a></span>" +
            "</div>" +
            "<div class='month'> <%= month %> </div>" +
            "<div class='clndr-control-button rightalign'>" +
                "<span class='clndr-next-button'><a id='currentmonth' href='javascript:void(0)' data-year='<%= year %>' data-month='<%= month %>'><i class='fa fa-angle-right' aria-hidden='true'></i></a></span>" +
            "</div>" +
        "</div>" +
