...
function WPCW_AJAX_course_handleEnrollment_button()
{
	...
	foreach ($courseIDs as $courseID)
	{
		...
		if ($userCourses){
			echo WPCW_UnitFrontend::message_createMessage_success(__('Success! You have been enrolled into', 'wp_courseware') . ' ' . $courseDetails->course_title);
		}else{
			echo WPCW_UnitFrontend::message_createMessage_error(__('Oops! Something went wrong. Please contact the course instructor for more information.', 'wp_courseware'));
		}
	}
	die();
}
