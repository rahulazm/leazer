	...
	// No course tool here...
		...
		if ( ! empty($coursesSelect) ) {
			...
			$formDetails['course_prerequisites_none_message'] = array(
				...
				'labelposition' => 'top',
				'type'          => 'custom',
				'html'          => sprintf( '<em>%s</em><br /><br /><a class="button-primary" href="%s">%s</a>',
					__('There are currently no other courses available. Please add more courses to add course prerequisites to this course.', 'wp_courseware'),
					add_query_arg( array( 'page' => 'WPCW_showPage_ModifyCourse' ), esc_url( admin_url( 'admin.php' ) ) ),
